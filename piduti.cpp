...

{
    ...
    //
    pObj = (PPERF_OBJECT_TYPE) ((PTRWORD)pPerf + pPerf->HeaderLength);

    //
    // loop thru the performance counter definition records looking
    // for the process id counter and then save its offset
    //
    pCounterDef = (PPERF_COUNTER_DEFINITION) ((PTRWORD)pObj + pObj->HeaderLength);
    ...
    pInst = (PPERF_INSTANCE_DEFINITION) ((PTRWORD)pObj + pObj->DefinitionLength);
    ...
    for (i=0; i<dwNumTasks; i++) {
	   ...
	   //
	   p = (LPSTR) ((PTRWORD)pInst + pInst->NameOffset);
	   ...
	   // get the process id
	   //
	   pCounter = (PPERF_COUNTER_BLOCK) ((PTRWORD)pInst + pInst->ByteLength);
	   pTask->flags = 0;
	   pTask->dwProcessId = *((LPDWORD) ((PTRWORD)pCounter + dwProcessIdCounter));
	   ...
	   //
	   pTask++;
	   pInst = (PPERF_INSTANCE_DEFINITION) ((PTRWORD)pCounter + pCounter->ByteLength);
    }
